...
function validateAppearanceModels(library: VehicleCrewAnimationPoseLibrary) {
  ...
  if (
    ...
    crowdReal?.assetUrl !==
      "/assets/vehicle-crew/models/reference-soldier-crowd-real-6dd9143cb902f921c44b68b0da3604b8e6245dba67c16d108bb4353a8addf737.glb" ||
    crowdReal.sha256 !==
      "6dd9143cb902f921c44b68b0da3604b8e6245dba67c16d108bb4353a8addf737" ||
    crowdReal.state !== "derived-meshoptimizer-skinned-lod" ||
    crowdReal.boneCount !== library.compatibleBoneCount ||
    crowdReal.triangles !== 12_816 ||
    crowdReal.triangles > 13_000 ||
    crowdReal.vertices !== 24_341 ||
    crowdReal.bytes !== 1_681_660 ||
