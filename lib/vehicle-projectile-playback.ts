...
export type NativeProjectileSweep = (input: {
  ...
  deltaSeconds: number;
}) => { timeFraction: number; normal?: ProjectileVector3; impactNormal: ProjectileVector3 } | null;
...
export function buildVehicleProjectileSimulationInput(
  ...
  // SQProjectile::PostInitializeComponents replaces the root sphere's CDO
  // radius with CollisionSize before flight.
